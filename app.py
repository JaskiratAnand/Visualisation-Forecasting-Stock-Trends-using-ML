...
st.title('Visualisation & Forecasting Stock Trends')
...
# describing data
st.subheader('Data from Jan 2010 - Dec 2021')
...
st.subheader('Closing price vs Time Chart with 100days & 200days Moving Average')
